                        ...
                        <tbody>
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    $size = isset($row["size"]) ? $row["size"] : "small";
                                    $pizzaPrice = ($size == "small") ? $myrow["pizzaPriceSmall"] : $myrow["pizzaPriceLarge"];
                    ...
                    <div class="pt-4 border bg-light rounded p-3">
                        ...
                        <ul class="list-group list-group-flush">
                           ...
                           <form id="checkoutForm" action="" method="POST">
                               <input type="radio" name="paymentMethod" value="cod" id="cod" required> Cash on Delivery<br>
                                <input type="radio" name="paymentMethod" value="online" id="online" required> Online Payment
                                 <br>
                                <button type="button" class="btn btn-primary btn-block" onclick="redirectToCheckout()">Go to Checkout</button>
                            </form>
