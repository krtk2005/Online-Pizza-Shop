...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
            $selectedSize = isset($_POST["size"]) ? $_POST["size"] : "small";
            $pizzaPrice = ($selectedSize == "large") ? $pizzaLargePrice : $pizzaSmallPrice;
...
<body>
    ...
    <div class="container my-4" id="cont">
        ...
        <?php
            ...
            $pizzaSmallPrice = $row['pizzaPriceSmall'];
            $pizzaLargePrice = $row['pizzaPriceLarge'];
