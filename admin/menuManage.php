...
while ($pizzaRow = mysqli_fetch_assoc($pizzaResult)) {
	...
	$pizzaPriceLarge = $pizzaRow['pizzaPriceLarge'];
	$pizzaCategorieId = $pizzaRow['pizzaCategorieId'];
	$pizzaDesc = $pizzaRow['pizzaDesc'];
	?>

	<!-- Modal -->
	<div class="modal fade" id="updateItem<?php echo $pizzaId; ?>" tabindex="-1" role="dialog"
		aria-labelledby="updateItem<?php echo $pizzaId; ?>" aria-hidden="true">
				...
				<div class="modal-body">
					<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
						<div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
							...
							<div class="form-group col-md-4">
								<img src="/OnlinePizzaDelivery/img/pizza-<?php echo $pizzaId; ?>.jpg" id="itemPhoto"
					...
					<form action="partials/_menuManage.php" method="post">
						<div class="text-left my-2">
							...
							<input class="form-control" id="name" name="name" value="<?php echo $pizzaName; ?>" type="text"
								required>
						</div>
						<div class="text-left my-2 row">
							<div class="form-group col-md-6">
								<b><label for="price">Price</label></b>
								<input class="form-control" id="price" name="price" value="<?php echo $pizzaPriceLarge; ?>"
									type="number" min="1" required>
							</div>
							<div class="form-group col-md-6">
								<b><label for="catId">Category Id</label></b>
								<input class="form-control" id="catId" name="catId" value="<?php echo $pizzaCategorieId; ?>"
									type="number" min="1" required>
							</div>
						</div>
						<div class="text-left my-2">
							...
							<textarea class="form-control" id="desc" name="desc" rows="2" required
								minlength="6"><?php echo $pizzaDesc; ?></textarea>
						</div>
						<input type="hidden" id="pizzaId" name="pizzaId" value="<?php echo $pizzaId; ?>">
